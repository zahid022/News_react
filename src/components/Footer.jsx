    ...
    <footer className='bg-[#191919]'>
      <div className="container mx-auto px-4 2xl:w-[1300px]">
        <div className='pt-10 pb-5'>
          <div className='flex pb-5 border-b border-[#232323] flex-wrap'>
            <div className='lg:w-[40%] lg:pr-10 w-full'>
              <div className='text-white'>
                <Link className='mb-3 block' to={'/'}>
                  <svg
                    ...
                    className="w-[80px] text-gray-900 dark:text-white"
                  >
                    <path
                ...
                <p className='text-[14px] md:text-[16px]'>A comprehensive electronic newspaper that deals with all issues that concern national public opinion.</p>
            ...
            <div className='lg:w-[60%] mt-4 lg:mt-0 w-full'>
              <div className='flex flex-wrap'>
                <ul className='w-6/12 lg:w-4/12 text-[14px] text-white'>
                  <p className='text-[#8C8C85] mb-2'>Topics</p>
                  <li className='mb-1'>Social</li>
                  <li className='mb-1'>Politics</li>
                  <li className='mb-1'>Economy</li>
                  <li className='mb-1'>World</li>
                  <li className='mb-1'>Sports</li>
                  <li className='mb-1'>Arts</li>
                </ul>
                <ul className='w-6/12 lg:w-4/12 text-[14px] text-white'>
                  <p className='text-[#8C8C85] mb-2'>Trending now</p>
                  <li className='mb-1'>Podcats</li>
                  <li className='mb-1'>News TV</li>
                  <li className='mb-1'>National</li>
                  <li className='mb-1'>Global</li>
                  <li className='mb-1'>Dialogues</li>
                  <li className='mb-1'>Opinions</li>
                </ul>
                <ul className='hidden lg:block text-[14px] lg:w-4/12 text-white'>
                  <p className='text-[#8C8C85] mb-2'>About</p>
